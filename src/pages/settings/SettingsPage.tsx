...
export function SettingsPage() {
  ...
  return (
    <div className="pt-12">
      ...
      <section className="mx-[22px] mt-5 flex min-h-[60.78px] gap-2 rounded-[16px] bg-white/70 px-[15px] py-3 text-[12px] font-normal leading-[18px] text-[#c4a8ab]">다시와는 현재 베타 테스트 중이에요. 원장님들이 더 편하게 고객을 관리할 수 있도록 계속 다듬고 있습니다.</section>
