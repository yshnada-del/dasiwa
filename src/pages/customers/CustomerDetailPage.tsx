  ...
  return (
    <div className="pt-12">
      ...
      {customer ? <>
        ...
        <div className="h-2 bg-[#f2e6df]" />
        <section className="px-[22px] py-[18px]"><div className="flex h-[21px] items-center justify-between"><h2 className="text-[14px] font-bold leading-[21px] tracking-[-0.3px] text-dasiwa-text">후기 요청 문구</h2><button className="text-[12px] font-bold text-[#c4a8ab]" disabled type="button">베타 준비 중</button></div><div className="mt-3 rounded-[13px] border border-[#ead8d0] bg-[#fffcf9] px-[17px] py-[15px]"><p className="min-h-[72px] whitespace-pre-wrap text-[13px] font-normal leading-[22.1px] tracking-[-0.1px] text-[#9b7478]">후기 요청 문구 생성은 현재 베타 버전에서는 사용할 수 없어요. 정식 버전에서 고객 시술 기록을 바탕으로 자연스러운 후기 요청 문구를 만들 수 있도록 준비 중이에요.</p><Button className="mt-3 min-h-[44px] w-full rounded-[11px] border border-[#ead8d0] bg-[#f8f1ee] text-[13.5px] leading-[20.25px] tracking-[-0.2px] text-[#9b7478] shadow-none" disabled type="button" variant="secondary"><Sparkles className="size-4" />베타 기간 사용 불가</Button></div></section>
